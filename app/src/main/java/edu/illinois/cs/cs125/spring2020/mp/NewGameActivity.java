...
public final class NewGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        // Get references to, then clear, the game setting layout containers
        ...
        // RadioGroup containing game mode RadioButtons and their corresponding handlers
        modeGroup = findViewById(R.id.gameModeGroup);
        // Register button click handler on the area mode and target mode option buttons
    ...
    private void centerMap(final GoogleMap map) {
        // Bounds of campus town and some surroundings
